...
class LogPanel(ctk.CTkFrame):
    def __init__(self, master: ctk.CTkBaseClass) -> None:
        ...
        title = ctk.CTkLabel(self, text="Log", font=ctk.CTkFont(size=20, weight="bold"), text_color="#21261F")
        title.grid(row=0, column=0, padx=16, pady=(14, 10), sticky="w")

        self.textbox = ctk.CTkTextbox(self, fg_color="#FBFBF8", text_color="#314033", corner_radius=18)
